const portfolioData = {
    personal: {
        bio: "<p>I am a Brooklyn-based cloud technology professional and AWS Certified Cloud Practitioner. Coming from a background in project management and operations, I thrive on taking complex, moving pieces and figuring out how they efficiently fit together.</p><p>My journey into cloud computing started with generative AI and workflow automation. I quickly realized that architecting secure, automated, and highly available digital environments is just a massive puzzle—requiring the exact same discipline and meticulous planning I used to coordinate physical construction projects.</p><p>Today, I am fully immersed in the AWS ecosystem. I am actively expanding my technical toolkit with Python, Linux, Terraform, and Docker through ambitious hands-on projects, and I am eager to bring my love for problem-solving to a team that values resilient architecture.</p>",
